...
(function() {
    ...
    window.addEventListener('load', function() {
        setTimeout(function() {
            ...
            //GM_addStyle('.reply-box.fixed-box[data-v-7ded8222] {padding: 5px 0 !important;}');//24-6-21
            GM_addStyle('.sub-reply-item .sub-reply-info[data-v-1f8a4018] {margin-top: -4px !important;}');//24-6-12
            GM_addStyle('.sub-reply-item[data-v-1f8a4018] {line-height: 0px !important;padding: 2px 0 0px 42px !important;}');//24-6-21
            GM_addStyle('.reply-item .bottom-line[data-v-7041f671] {margin-top: 0px !important;}');//24-6-21
            GM_addStyle('.reply-item .root-reply-container[data-v-7041f671] {padding: 0px 0 0 80px !important;}');//24-6-21
            GM_addStyle('.reply-item .root-reply-container .content-warp .user-info[data-v-7041f671] {margin-bottom: -10px !important;}');//24-6-21
